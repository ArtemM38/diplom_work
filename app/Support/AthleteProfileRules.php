...
class AthleteProfileRules
{
    ...
    public static function rules(): array
    {
        return [
            ...
            'school_name' => 'nullable|required_if:occupation_type,study|string|max:255',
            ...
            'kindergarten_name' => 'nullable|required_if:occupation_type,kindergarten|string|max:255',
            'work_place' => 'nullable|required_if:occupation_type,work|string|max:255',
