...
const navigation = computed(() => [
    ...
    { name: 'Расписание', href: safeRoute('admin.schedule'), icon: '', roles: ['admin', 'coach'] },
    { name: 'Мое расписание', href: safeRoute('athlete.schedule.calendar', safeRoute('dashboard')), icon: '', roles: ['athlete'] },
