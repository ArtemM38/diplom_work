...
const navigation = computed(() => [
    ...
    { name: 'Результаты ребёнка', href: safeRoute('guardian.portfolio', safeRoute('dashboard')), roles: ['guardian'] },
    ...
    { name: 'Инвентарь', href: safeRoute('admin.inventory-items'), roles: ['admin'] },
